...
import cn.weeget.youxuan.hotfix.loader.HotFixFlutterLoader;
 ...
 * behavior.</strong>
 */
/* package */ class HotFixFlutterActivityAndFragmentDelegate implements ExclusiveAppComponent<Activity> {
    ...
    @NonNull private HotFixFlutterActivityAndFragmentDelegate.Host host;
    @Nullable private FlutterEngine flutterEngine;
    @Nullable private HotFixFlutterSplashView flutterSplashView;
    ...
    HotFixFlutterActivityAndFragmentDelegate(@NonNull HotFixFlutterActivityAndFragmentDelegate.Host host) {
        this.host = host;
    }
     ...
     *       HotFixFlutterActivityAndFragmentDelegate.Host#configureFlutterEngine(FlutterEngine)}.
     * </ol>
     */
     ...
     * {@link HotFixFlutterActivityAndFragmentDelegate.Host#provideFlutterEngine(Context)}.
     *
...
//                        /*willProvideRestorationData=*/ host.shouldRestoreAndSaveState());
        flutterEngine =
                new FlutterEngine(
                        host.getContext(),
                        HotFixFlutterLoader.getInstance(),
                        new FlutterJNI(),
    ...
    View onCreateView(
        ...
        flutterSplashView = new HotFixFlutterSplashView(host.getContext());
     ...
     *       HotFixFlutterActivityAndFragmentDelegate.Host#shouldDestroyEngineWithHost()} ()} returns true.
     * </ol>
     */
    void onDetach() {
        Log.v(TAG, "onDetach()");
