 ...
 * a cached {@link FlutterEngine}, ensure that the {@link FlutterEngine} is stored in {
 ...
 */
public class HotFixFlutterFragment extends Fragment implements HotFixFlutterActivityAndFragmentDelegate.Host {
    ...
    /**
     * The ID of a {@link FlutterEngine} cached in { FlutterEngineCache} that will be used within
     ...
     */
    @NonNull
    public static HotFixFlutterFragment createDefault() {
    ...
    public static class NewEngineFragmentBuilder {
        private final Class<? extends HotFixFlutterFragment> fragmentClass;
        ...
        public NewEngineFragmentBuilder() {
            fragmentClass = HotFixFlutterFragment.class;
        }
         ...
         */
        public NewEngineFragmentBuilder(@NonNull Class<? extends HotFixFlutterFragment> subclass) {
        ...
        /**
         * The initial route that a Flutter app will render in this {@link HotFixFlutterFragment}, defaults to
         * "/".
         */
        @NonNull
         ...
         * which defaults to { FlutterLoader#findAppBundlePath()}
         */
        @NonNull
         ...
         * Activity}-specific calls, e.g., { android.app.Activity#onNewIntent(Intent)}. If {@code
         ...
         */
        @NonNull
        public <T extends HotFixFlutterFragment> T build() {
            try {
     ...
     * {@link FlutterEngine} in { FlutterEngineCache}.
     *
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        private CachedEngineFragmentBuilder(@NonNull String engineId) {
            this(HotFixFlutterFragment.class, engineId);
        }

        protected CachedEngineFragmentBuilder(
                @NonNull Class<? extends HotFixFlutterFragment> subclass, @NonNull String engineId) {
    ...
    @VisibleForTesting /* package */ HotFixFlutterActivityAndFragmentDelegate delegate;

    public HotFixFlutterFragment() {
    ...
    @VisibleForTesting
    /* package */ void setDelegate(@NonNull HotFixFlutterActivityAndFragmentDelegate delegate) {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        delegate = new HotFixFlutterActivityAndFragmentDelegate(this);
     ...
     * Fragment}.
     *
     * <p>See { android.app.Activity#onNewIntent(Intent)}
     *
     * <p>
     *
     ...
     *
     * <p>See { android.app.Activity#onUserLeaveHint()}
     */
    @ActivityCallThrough
     ...
     * <p>Defaults to "main".
     *
     * <p>Used by this {@code FlutterFragment}'s { FlutterActivityAndFragmentDelegate.Host}
     */
    @Override
    @NonNull
     ...
     * snapshots.
     *
     * <p>When unspecified, the value is null, which defaults to the app bundle path defined in {
     ...
     *
     * <p>Used by this {@code FlutterFragment}'s { FlutterActivityAndFragmentDelegate}
     */
    @Override
