package cn.weeget.youxuan.hotfix;
...
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.DART_ENTRYPOINT_META_DATA_KEY;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.DEFAULT_BACKGROUND_MODE;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.DEFAULT_DART_ENTRYPOINT;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.DEFAULT_INITIAL_ROUTE;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.EXTRA_BACKGROUND_MODE;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.EXTRA_CACHED_ENGINE_ID;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.EXTRA_DESTROY_ENGINE_WITH_ACTIVITY;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.EXTRA_INITIAL_ROUTE;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.INITIAL_ROUTE_META_DATA_KEY;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.NORMAL_THEME_META_DATA_KEY;
import static cn.weeget.youxuan.hotfix.HotFixFlutterActivityLaunchConfigs.SPLASH_SCREEN_META_DATA_KEY;
...
// FlutterActivity, too.
public class HotFixFlutterFragmentActivity extends FragmentActivity
        implements SplashScreenProvider, FlutterEngineProvider, FlutterEngineConfigurator {
    private static final String TAG = "HotFixFlutterFragmentActivity";
    ...
    /**
     * Creates an {@link Intent} that launches a {@code HotFixFlutterFragmentActivity}, which executes a
    ...
    /**
     * Creates an {@link HotFixFlutterFragmentActivity.NewEngineIntentBuilder}, which can be used to
     ...
     */
    @NonNull
    public static HotFixFlutterFragmentActivity.NewEngineIntentBuilder withNewEngine() {
        return new HotFixFlutterFragmentActivity.NewEngineIntentBuilder(HotFixFlutterFragmentActivity.class);
    }
    ...
    public static class NewEngineIntentBuilder {
        private final Class<? extends HotFixFlutterFragmentActivity> activityClass;
         ...
         */
        public NewEngineIntentBuilder(@NonNull Class<? extends HotFixFlutterFragmentActivity> activityClass) {
         ...
         */
        @NonNull
        public HotFixFlutterFragmentActivity.NewEngineIntentBuilder initialRoute(@NonNull String initialRoute) {
         ...
         */
        @NonNull
        public HotFixFlutterFragmentActivity.NewEngineIntentBuilder backgroundMode(@NonNull BackgroundMode backgroundMode) {
    ...
    /**
     * Creates a {@link HotFixFlutterFragmentActivity.CachedEngineIntentBuilder}, which can be used to configure an {@link Intent}
     ...
     */
    @NonNull
    public static HotFixFlutterFragmentActivity.CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new HotFixFlutterFragmentActivity.CachedEngineIntentBuilder(HotFixFlutterFragmentActivity.class, cachedEngineId);
    }
    ...
    public static class CachedEngineIntentBuilder {
        ...
        public CachedEngineIntentBuilder(
                @NonNull Class<? extends HotFixFlutterFragmentActivity> activityClass, @NonNull String engineId) {
            this.activityClass = activityClass;
         ...
         */
        public HotFixFlutterFragmentActivity.CachedEngineIntentBuilder destroyEngineWithActivity(boolean destroyEngineWithActivity) {
         ...
         */
        @NonNull
        public HotFixFlutterFragmentActivity.CachedEngineIntentBuilder backgroundMode(@NonNull BackgroundMode backgroundMode) {
            this.backgroundMode = backgroundMode.name();
            return this;
        }
    ...
    @Nullable private HotFixFlutterFragment flutterFragment;
     ...
     *
     * <p>See { FlutterActivityLaunchConfigs#SPLASH_SCREEN_META_DATA_KEY} for the meta-data key
     ...
     * the {@link HotFixFlutterFragment} displayed by this {@code FlutterFragmentActivity}.
     *
     * <p>
     *
    ...
    /**
     * Ensure that a {@link HotFixFlutterFragment} is attached to this {@code FlutterFragmentActivity}.
     *
     * <p>If no {@link HotFixFlutterFragment} exists in this {@code FlutterFragmentActivity}, then a {@link
     * HotFixFlutterFragment} is created and added. If a {@link HotFixFlutterFragment} does exist in this {@code
     * FlutterFragmentActivity}, then a reference to that {@link HotFixFlutterFragment} is retained in
     * {@code #flutterFragment}.
     */
    private void ensureFlutterFragmentCreated() {
        FragmentManager fragmentManager = getSupportFragmentManager();
        flutterFragment = (HotFixFlutterFragment) fragmentManager.findFragmentByTag(TAG_FLUTTER_FRAGMENT);
    ...
    /**
     * Creates the instance of the {@link HotFixFlutterFragment} that this {@code FlutterFragmentActivity}
     * displays.
     *
     * <p>Subclasses may override this method to return a specialization of {@link HotFixFlutterFragment}.
     */
    @NonNull
    protected HotFixFlutterFragment createFlutterFragment() {
        ...
        if (getCachedEngineId() != null) {
            ...
            return HotFixFlutterFragment.withCachedEngine(getCachedEngineId())
            ...
            HotFixFlutterFragment flutterFragment =  HotFixFlutterFragment.withNewEngine()
    ...
    /**
     * Hook for subclasses to control whether or not the {@link HotFixFlutterFragment} within this {@code
     ...
     * HotFixFlutterFragment.NewEngineFragmentBuilder#shouldAttachEngineToActivity()}.
     *
     ...
     *
     * <p>This preference can be controlled by setting a {@code <meta-data>} called {
     ...
     *
     * <ol>
     *   <li>Pass a boolean as { FlutterActivityLaunchConfigs#EXTRA_INITIAL_ROUTE} with the
     ...
     *
     * <p>That is, {@link RenderMode#surface} if {@link HotFixFlutterFragmentActivity#getBackgroundMode()}
     * is { BackgroundMode.opaque} or {@link RenderMode#texture} otherwise.
     */
    @NonNull
