 ...
 * first frame.
 */
/* package */ final class HotFixFlutterSplashView extends FrameLayout {
    ...
    public HotFixFlutterSplashView(@NonNull Context context) {
        this(context, null, 0);
    }

    public HotFixFlutterSplashView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HotFixFlutterSplashView(
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        HotFixFlutterSplashView.SavedState savedState = new HotFixFlutterSplashView.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        HotFixFlutterSplashView.SavedState savedState = (HotFixFlutterSplashView.SavedState) state;
    ...
    public static class SavedState extends BaseSavedState {
        public static Creator<HotFixFlutterSplashView.SavedState> CREATOR =
                new Creator<HotFixFlutterSplashView.SavedState>() {
                    @Override
                    public HotFixFlutterSplashView.SavedState createFromParcel(Parcel source) {
                        return new HotFixFlutterSplashView.SavedState(source);
                    }

                    @Override
                    public HotFixFlutterSplashView.SavedState[] newArray(int size) {
                        return new HotFixFlutterSplashView.SavedState[size];
                    }
                };
